...
So, strictly speaking, in the definition we should replace 
`set' with `multiset'.
However, most of the time the distinction won't matter and
departing from the standard terminology has its own pitfalls, so we will 
keep the practice of referring to a linearly independent or dependent `set.'
\end{remark}
