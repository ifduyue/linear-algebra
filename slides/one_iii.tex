...
Gauss's method takes linear combinations of the rows, 
...
\iftoggle{showallproofs}{
  ...
  \bigskip
  The book contains the full proof.
  \ex This Gauss-Jordan reduction shows that the matrix
  is row equivalent to that reduced echelon form matrix.
  \begin{equation*}
    \begin{mat}
      1 &2 &1 \\
      2 &4 &0 \\
    ...
    \end{mat}
  \end{equation*}
  By the theorem it is not row equivalent to any of these.
  \begin{equation*}
    \begin{mat}
      1 &0 &0 \\
      0 &1 &0 \\
