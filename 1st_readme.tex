...
\iffancytitle
  ...
  \begin{center}
    \begin{picture}(0,0)(0,0)
      ...
      \put(0,-350){\makebox[0pt]{\large\scshape\begin{tabular}{c} Jim Hef{}feron \\[0.75ex] \input{publicationdate}\end{tabular}}}
    \end{picture}
  \end{center}
...
from your bookstore.
But note that hard copies are for sale from major distributers such as
Amazon and the college bookstore distributer; the price is less than
it used to cost to get our print shop to make comb-bound versions.
...
exercise, can send me the correction (email me a section and subsection 
number and a description, ideally and also a correction).

I welcome contribution of work back to the project.
I of course reserve the ability to not use some things but all
the contributions that I do use are acknowledged in the file
...
It is not especially tough but you might want to start with a two page,
or a ten page document.
Just saying.
 
To get this document to come out, 
...
has a slightly different approach and, I'm sorry, I can't help with that.
...
\begin{center}
  \begin{tabular}{r|l}
    ...
    \texttt{bookjhconcrete.sty}   &Formatting instructions  \\
    \texttt{linalgjh.sty} &Macros for Linear Algebra \\
    \texttt{jhanswer.tex} &Main file for the answers \\
    \texttt{cover.tex} &Make the front, back, and spine \\
  \end{tabular}
\end{center}
...
There are also some graphic files for the Asymptote system, in the
subdirectory \texttt{/asy}.
...
works for me.
I have the \TeX{}Live that comes with Ubuntu's package system.
For line-by-line details, see the file \texttt{1ST\textunderscore{}README}.
...
You can generate slides by changing into the \verb!\slides! directory
...
\end{verbatim}
     ...
     \item 
         ...
         on the planet who can come up in minutes 
