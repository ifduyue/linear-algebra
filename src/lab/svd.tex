...
Because of the $t(r\cdot\vec{v})=r\cdot t(\vec{v})$ relationship,
...
To start we take a simple transformation.
\begin{equation*}
...
\inlinecode{plot_circle_action(a,b,c,d)}, which 
...
% \end{center}
\begin{center}
  \includegraphics[width=.95\textwidth]{pix/greatwave.png} % from http://en.wikipedia.org/wiki/File:Lenna.png
\end{center}
