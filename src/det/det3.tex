...
row swap, to put the row~$\rowvec{1 &0 &0}$ into the first row.
Of course, that row swap puts a negative sign on that line.
Finally, setting up the third line's matrices $P_{\phi_5}$ and~$P_{\phi_6}$
in the same way takes two
row swaps, which keeps the sign positive.
%</dis:LaplaceIntro4>
