...
We finish by describing one more thing about the projective plane. 
...
$Q_0$ and~$Q_1$, but it is a single point in the projective plane.
At that point we have drawn Cartesian axes, $xy$-axes.
These axes appear in the picture at both antipodal spots, 
one in the northern hemisphere at $Q_0$ and the other in the
south at~$Q_1$.
Observe that
...
show a trip around this space along the projective line:~$Q_0$ 
moves up and over the north pole, ending on the
far side of the sphere, and its companion~$Q_1$ comes to the front.
