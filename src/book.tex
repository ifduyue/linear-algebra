...
det/det1,det/det2,det/det3,det/cramer,det/detspeed,det/chio,det/projplane,%
jc/jc1,jc/jc2,jc/jc3,jc/jc4,jc/powers,jc/pops,jc/search,jc/recur,jc/wilber,%eigengeom,prinaxis,%
appen/appen,%
bib/bib%
%test%
}%
...
\include{det/det3} 
\pagestyle{booktopic}
  \include{det/cramer} \include{det/detspeed} \include{det/chio}  \include{det/projplane} \pagestyle{bookbody}
\include{jc/jc1}
\include{jc/jc2}
\include{jc/jc3}
\include{jc/jc4}
\pagestyle{booktopic}
  \include{jc/powers} \include{jc/pops} \include{jc/search} \include{jc/recur} \include{jc/wilber} \pagestyle{bookbody}
%\include{eigengeom}
\include{appen/appen}
