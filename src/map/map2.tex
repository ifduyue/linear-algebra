...
\begin{equation*}
  ...
  \colvec{0 \\ 5x}
\end{equation*}
the linear combination \( 5f-2g \) is also a transformation of~$\Re^2$.
\begin{equation*}
  \colvec{x \\ y}
   \mapsunder{5f-2g}
  \colvec{10x \\ 5x-10y}
...
\begin{exercises}
  ...
  \item Verify that each map is a homomorphism.
    \begin{exparts}
      \partsitem $\map{h}{\polyspace_2}{\Re^2}$ given by
        \begin{equation*}
  ...
  \recommended \item
    ...
    How much extra rope must we add so that around 
    the entire world the rope will now be six feet off the ground?
    \begin{answer}
  ...
  \item 
    ...
    Show that for any scalars \( a_{1,1},\dots, a_{m,n}  \) 
    this map
    ...
    \begin{answer}
      Where \( c \) and \( d \) are scalars, we have this.
          ...
          \end{multline*}
     \end{answer}
   \item Consider the space of polynomials  \( \polyspace_n \).
     \begin{exparts}
       \partsitem Show that for each $i$, the \( i \)-th derivative operator 
          $d^i/dx^i$ is a linear transformation of that space.
       \partsitem
      ...
      \begin{answer}
        \begin{exparts}
         ...
         \partsitem 
          ...
          Thus,
          the given map is a linear transformation of \( \polyspace_n \).
        \end{exparts}
      \end{answer}
  \item 
