...
In the examples after the definition of a vector space
we expressed the intuition that some spaces are essentially the same as others.
For instance, 
...
% not equal, 
we may perceive that the space of two-by-two matrices and 
the space of four tall vectors
\begin{equation*}
  \matspace_{\nbyn{2}}=\set{
    \begin{pmatrix}
      a &b \\
...
\end{equation*}
are not equal because their elements are not the same, but that they 
differ only cosmetically.
We will now make this precise.

This illustrates a common phase of a mathematical investigation.
With the help of some examples we've gotten an idea.
We will next give a formal definition and then
produce some results backing our contention 
...
we will get two pleasant surprises.
