...
\begin{picture}(1,9.5)
  ...
  \put(0.18,8.5){\rotatebox[origin=lc]{-90}{\spinetext{Linear Algebra}\hspace{01.75in}\spineauthortext{Hef{}feron}}}
...
This book
is freely available online, and has been for many years. 
It is widely used, 
