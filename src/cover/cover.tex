...
% \definecolor{coverbgcolor}{RGB}{103,0,153}
\definecolor{coverbgcolor}{RGB}{212,175,55}
% \definecolor{coverboldcolor}{RGB}{255,78,78}
\definecolor{coverboldcolor}{RGB}{0,67,37}
% \colorlet{coverboldcolor}{\color[RGB]{255,78,78}}
...
\newcommand{\spineauthortext}[1]{\color{coverdarkcolor}\fontsize{25pt}{8pt}{\fontfamily{ugq}\selectfont{#1}}}
\newcommand{\spine}{%
\setlength{\unitlength}{1in}
\begin{picture}(1,9.5)
  \setstackgap{S}{2.1ex}
  % \put(0.235,5.65){\Shortstack{{\spinetext{L}} {\spinetext{I}} {\spinetext{N}} {\spinetext{E}} {\spinetext{A}} {\spinetext{R}}}}
  \put(0.18,8.5){\rotatebox[origin=lc]{-90}{\spinetext{Linear Algebra}\hspace{01.5in}\spineauthortext{Hefferon}}}
