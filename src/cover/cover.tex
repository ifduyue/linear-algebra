...
\colorlet{coverbgcolor}{blue}
\colorlet{coverboldcolor}{red}
...
\newcommand{\spinetext}[1]{\color{black}\fontsize{50pt}{8pt}{\fontfamily{ugq}\selectfont #1}}
% \newcommand{\spineauthortext}[2]{\color{coverdarkcolor}\fontsize{#2pt}{8pt}{\fontfamily{ugq}\selectfont{#1}}}
\newcommand{\spineauthortext}[1]{\color{coverdarkcolor}\fontsize{30pt}{8pt}{\fontfamily{ugq}\selectfont{#1}}}
\newcommand{\spine}{%
\setlength{\unitlength}{1in}
\begin{picture}(1,9.5)
  \setstackgap{S}{2.1ex}
  % \put(0.235,5.65){\Shortstack{{\spinetext{L}} {\spinetext{I}} {\spinetext{N}} {\spinetext{E}} {\spinetext{A}} {\spinetext{R}}}}
  \put(0.18,8.75){\rotatebox[origin=lc]{-90}{\spinetext{Linear Algebra}\hspace{01.1in}\spineauthortext{Hefferon}}}
...
% \newcommand{\frontcoverurltext}[1]{\color[gray]{0.7}\fontsize{18pt}{6pt}\fontfamily{ugq}\selectfont \textsf{#1}}
...
\begin{picture}(0,0) 
  ...
  \put(9.1,-7.57){\includegraphics{asy/axes.pdf}}
  \put(9.1,-8.5){\includegraphics{asy/shadow.pdf}}
  \put(15,-3){\makebox[0pt][r]{\frontcovertext{Linear Algebra}}}
  \put(15,-3.75){\makebox[0pt][r]{\frontcoverauthortext{Jim Hef{}feron}}}
  \put(15,-7.85){\makebox[0pt][r]{\frontcoverurltext{joshua.smcvt.edu/linearalgebra}}}
  \put(7.5,-9.5){\spine}
