...
\definend{norm} operation\index{norm}, 
$\norm{\vec{v}}=\innerprod{\vec{v}}{\vec{v}}$.

To show the association of inner products with length, we consider  
...
We pause to give more connection between these ideas and geometry.
