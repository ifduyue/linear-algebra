...
and we call $a$ the \definend{real part} of~$z$,
while $b$ is the \definend{imaginary part}.
...
\begin{example}
Matrix multiplication is the same, although the arithmetic involves more
bookkeeping.
\begin{multline*}
  \begin{mat}
     1+1i  &2-0i  \\
