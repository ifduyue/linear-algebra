...
\usepackage{xr}\externaldocument{\jcdir jc1} % read refs from .aux file
...
\ExecuteMetaData[\jcdir jc1.tex]{ReasonForShiftToComplexNumbers}
...
\ExecuteMetaData[\jcdir jc1.tex]{PolynomialReview0}  

\pause
\ExecuteMetaData[\jcdir jc1.tex]{PolynomialReview1}  
...
\begin{frame}
\th[th:EuclidForPolys]
\ExecuteMetaData[\jcdir jc1.tex]{th:EuclidForPolys}  
%\pause
\co[co:PolyDividedByLinearPolyIsConstant]
\ExecuteMetaData[\jcdir jc1.tex]{co:PolyDividedByLinearPolyIsConstant}  

%\pause
\pf
\ExecuteMetaData[\jcdir jc1.tex]{pf:PolyDividedByLinearPolyIsConstant}  
\qed

\pause
\ExecuteMetaData[\jcdir jc1.tex]{PolynomialFactor}  

\co[co:RootOfPolyIsAssocLinearFactor]
\ExecuteMetaData[\jcdir jc1.tex]{co:RootOfPolyIsAssocLinearFactor}

\pause
\pf  
\ExecuteMetaData[\jcdir jc1.tex]{pf:RootOfPolyIsAssocLinearFactor}  
\qed
\end{frame}
...
\ExecuteMetaData[\jcdir jc1.tex]{th:CubicsAndHigherFactor}

\pause
\co[co:RealPolysFactorIntoLinearsAndQuads]  
\ExecuteMetaData[\jcdir jc1.tex]{co:RealPolysFactorIntoLinearsAndQuads}
\end{frame}
...
\ExecuteMetaData[\jcdir jc1.tex]{ComplexNumbers}

\pause
\th[th:FundThmAlg]\textcolor{blue}{[Fundamental Theorem of Algebra]}  
\ExecuteMetaData[\jcdir jc1.tex]{th:FundThmAlg}
\end{frame}
...
\begin{frame}
\ExecuteMetaData[\jcdir jc1.tex]{ComplexOperations}  
